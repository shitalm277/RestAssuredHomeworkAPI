...
//verify that completed is false using  "completed": false
    @Test
    public void verify_getPosts_byId_andTitle(){
...
//verify that completed is false using  "completed": false
    ...
    //   Homework 2: - Test api endpoint https://jsonplaceholder.typicode.com/users/5//    verify that status code is success
...
//verify userid using value "title": "eveniet quod temporibus"
    ...
    public void verify_getPosts_byId(){
        ...
        //verify title using value  "userId": 2
        System.out.println(responseJson.getString("userId"));
